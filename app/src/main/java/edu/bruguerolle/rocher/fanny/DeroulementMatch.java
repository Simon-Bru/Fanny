...
public class DeroulementMatch extends Fragment {
    ...
    public static DeroulementMatch newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_deroulement_match, container, false);
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof InterfaceButtonsListener) {
            mListener = (InterfaceButtonsListener) context;
        } else {
     ...
     */
    public interface InterfaceButtonsListener {
